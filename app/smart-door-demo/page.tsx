...
export default function SmartDoorDemoPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[oklch(0.25_0.05_240)] to-[oklch(0.15_0.03_260)] p-4">
      <div className="w-full max-w-md">
        <Card
          className={`overflow-hidden border-2 border-[oklch(0.45_0.08_240)] bg-gradient-to-b from-[oklch(0.20_0.04_250)] to-[oklch(0.15_0.03_260)] p-8 text-white shadow-2xl transition-all duration-300 ${
          ...
          {state === "idle" && (
            <div className="flex flex-col items-center gap-8 text-center">
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-lg text-[oklch(0.70_0.05_240)]">房號 {roomNumber}</p>
              </div>
